...
public class Registration_Verification {
	...
	@Test(priority = 3, description = "This is a Registration With Valid Information")
	public void VerifyRegistration_With_Valid_Info() throws InterruptedException {

		SoftAssert softassert = new SoftAssert();
		String expected_error = "Registration Successful";
		...
		EmlBtn.click();
		Thread.sleep(1000);
		EmlBtn.sendKeys("randhirall23@gmail.com");
		Thread.sleep(1000);
		...
		// Type 2
		Assert.assertTrue(actual_error.contains("Registration Successful"));
